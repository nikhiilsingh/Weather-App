...
import WeatherBackground from './Components/WeatherBackgroundImage'
...
const App = () => {
  ...
  // THIS FUNCTIONS PREVENTS FROM SUBMISSION VALIDATES CITY AND FETCHES DATA VIA API
  ...
  // this function check weather exists and return a object
      ...
      <div className='flex items-center justify-center p-6 min-h-screen'>
        ...
        {!weather ? (
          <form onSubmit={handleSearch} className='flex flex-col relative' >
            ...
            className='mb-4 p-3 rounded border border-white bg-transperent text-white placeholder-white focus:outline-none focus:border-blue-300 transition duration-300 ' />
             {suggestion.length > 0 &&(
          ...
          <div className="mt-6 text-center transition-opacity duration-500 ">
            ...
            <div className="flex flex-wrap justify-around mt-6">
              {[
                ...
                [VisibilityIcon,'Visibiltiy',getVisibilityValue(weather.visibility)]
